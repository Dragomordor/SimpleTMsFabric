...
public class TMsTRsList {
    ...
    private static final List<MoveTutorItem> ALL_TMS = new ArrayList<>();
    ...
    // List to store all TM items
    private static final List<MoveTutorItem> ALL_TRS = new ArrayList<>();
    ...
    public static List<MoveTutorItem> getAllTMs() {
        return ALL_TMS;
    }

    // Method to get the list of TR items
    public static List<MoveTutorItem> getAllTRs() {
        return ALL_TRS;
    }
